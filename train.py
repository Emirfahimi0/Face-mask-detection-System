...
Usage - Single-GPU training:
    $ python train.py --data dataset.yaml --weights yolov5s.pt --img 640 --batch-size 12 --workers 1 --epochs 10  # from pretrained (recommended)
...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    last, best = w / 'last_custom_model.pt', w / 'best_custom_model.pt'
